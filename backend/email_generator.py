                                        ...
                                        <tr>
                                            <td style="vertical-align: top; padding-right: 20px;">
                                                <div style="width: 70px; height: 70px; border-radius: 50%; overflow: hidden; border: 3px solid #3b82f6; position: relative;">
                                                    <img src="https://teaching-platform-560659035104.europe-west1.run.app/profile.png" alt="Thiyanayugi Mariraj" style="width: 112px; height: 112px; max-width: none; margin-left: -35px; margin-top: -10px; object-fit: cover;">
                                                </div>
                                            </td>
