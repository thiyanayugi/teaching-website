...
const translations = {
    en: {
        ...
        formTopic: "I'm Interested In *",
        formTopicPlaceholder: "Select your interest...",
        ...
        formExpBeginner: "🌱 Beginner - Just starting out",
        formExpIntermediate: "🌿 Intermediate - Some experience",
        formExpAdvanced: "🌳 Advanced - Looking to specialize",
        formInterest: 'Specific Interest <span class="optional-tag">Optional</span>',
        formInterestPlaceholder: "e.g., Building chatbots with LLMs... / Automating warehouse robots...",
        formGoal: 'What do you want to achieve? <span class="optional-tag">Optional</span>',
        formGoalPlaceholder: "e.g., I want to build AI agents for my startup... / I need to automate workflows in my company...",
